-- 0227_drop_tenant_owned_mailbox_tables.sql
-- Removes the "shared company mailbox per tenant" tables introduced in
-- 0221_tenant_email_tokens.sql. That model was abandoned in favor of
-- per-user mailboxes (0224/0225/0226_*_per_user_mailbox.sql) and no code
